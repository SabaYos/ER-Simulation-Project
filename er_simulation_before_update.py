...
doctor_positions = [(300, 150), (400, 150)]  
nurse_positions = [(100, 150)]  
NUM_DOCTORS = 2  # 2 doctors
NUM_NURSES = 1  # 1 nurses
...
class Patient:
    def __init__(self, pid, severity, arrival_time):
        ...
        self.state = "arrived"
        # Registration time 4–6 minutes
        self.registration_time = random.uniform(8, 12)
...
def save_results():
    ...
    try:
        ...
        print(f"Error saving simulation_results.csv: {e}")

    try:
        with open("treatment_times.csv", mode="w", newline="") as file:
            writer = csv.writer(file)
        ...
        print("Saved treatment_times.csv")
    except Exception as e:
        print(f"Error saving treatment_times.csv: {e}")
...
def plot_results():
    ...
    try:
        ...
        plt.savefig('waiting_times_bar.png')
        plt.close()
        print("Saved waiting_times_bar.png")
    except Exception as e:
        print(f"Error generating waiting_times_bar.png: {e}")
    ...
    try:
        ...
        plt.grid(True)
        plt.savefig('waiting_times_histogram.png')
        plt.close()
        print("Saved waiting_times_histogram.png")
    except Exception as e:
        print(f"Error generating waiting_times_histogram.png: {e}")
    ...
    try:
        ...
        print(f"Error generating queue_size_over_time.png: {e}")
    ...
    try:
        ...
        plt.grid(True, axis='y')
        plt.savefig('treatment_times_bar.png')
        plt.close()
        print("Saved treatment_times_bar.png")
    except Exception as e:
        print(f"Error generating treatment_times_bar.png: {e}")
